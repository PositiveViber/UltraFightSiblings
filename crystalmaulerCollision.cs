...
//                    Vector2 knockbackForce = enemyKnockbackHandler.CalculateKnockback("NeutralAir", transform.position, enemy.transform.position, enemySprite.GetInteger("damage"));
...
//                    Vector2 knockbackForce = enemyKnockbackHandler.CalculateKnockback("UpAir", transform.position, enemy.transform.position, enemySprite.GetInteger("damage"));
//                    //Applied Damage to character
...
//                    Vector2 knockbackForce = enemyKnockbackHandler.CalculateKnockback("DownAir", transform.position, enemy.transform.position, enemySprite.GetInteger("damage"));
//                    //Applied Damage to character
...
//                    Vector2 knockbackForce = enemyKnockbackHandler.CalculateKnockback("SideAir", transform.position, enemy.transform.position, enemySprite.GetInteger("damage"));
//                    //Applied Damage to character
...
//                    Vector2 knockbackForce = enemyKnockbackHandler.CalculateKnockback("NeutralGround", transform.position, enemy.transform.position, enemySprite.GetInteger("damage"));
//                    // Apply the knockback force
//                    enemyRb.AddForce(knockbackForce, ForceMode2D.Impulse);
//                    Debug.Log("Complete.");
//                }
...
//                {
//                    // Perform the action for Up Air.
//                    Vector2 knockbackForce = enemyKnockbackHandler.CalculateKnockback("SideGround", transform.position, enemy.transform.position, enemySprite.GetInteger("damage"));
//                    // Apply the knockback force
//                    enemyRb.AddForce(knockbackForce, ForceMode2D.Impulse);
//                    Debug.Log("Complete.");
//                    // Similarly, differentiate between Weak and Strong Up Air as needed.
...
//                {
//                    // Perform the action for Down Air.
//                    Vector2 knockbackForce = enemyKnockbackHandler.CalculateKnockback("DownGround", transform.position, enemy.transform.position, enemySprite.GetInteger("damage"));
//                    // Apply the knockback force
//                    enemyRb.AddForce(knockbackForce, ForceMode2D.Impulse);
//                    Debug.Log("Complete.");
//                    // Differentiate between Weak and Strong Down Air as needed.
