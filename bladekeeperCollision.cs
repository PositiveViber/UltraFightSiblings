...
public class bladeKeeperCollision : MonoBehaviour
{
        ...
        foreach (Collider2D enemy in hitEnemies)
        {
            ...
            if (!enemySprite.GetBool("appliedKnockback"))
            {
                ...
                if (animator.GetBool("isNeutralAiring"))
                {
                    ...
                    Vector2 knockbackForce = enemyKnockbackHandler.CalculateKnockback("NeutralAir", transform.position, enemy.transform.position, enemySprite.GetInteger("damage"), 0.5f);
                ...
                else if (animator.GetBool("isUpAiring"))
                {
                    ...
                    //Applied Damage to character
                    enemySprite.SetInteger("damage", enemySprite.GetInteger("damage") + 13);
                    // Apply the knockback force
                    enemyRb.AddForce(knockbackForce, ForceMode2D.Impulse);
                    Debug.Log("Complete.");
                ...
                else if (animator.GetBool("isDownAiring"))
                {
                    ...
                    Vector2 knockbackForce = enemyKnockbackHandler.CalculateKnockback("DownAir", transform.position, enemy.transform.position, enemySprite.GetInteger("damage"), 1.0f);
                    //Applied Damage to character
                ...
                else if (animator.GetBool("isSideAiring"))
                {
                    ...
                    Vector2 knockbackForce = enemyKnockbackHandler.CalculateKnockback("SideAir", transform.position, enemy.transform.position, enemySprite.GetInteger("damage"), 0.9f);
                    //Applied Damage to character
                ...
                if (animator.GetBool("isNeutralGrounding"))
                {
                    ...
                    Vector2 knockbackForce = enemyKnockbackHandler.CalculateKnockback("NeutralGround", transform.position, enemy.transform.position, enemySprite.GetInteger("damage"), 0.7f);
                    // Apply the knockback force
                    enemyRb.AddForce(knockbackForce, ForceMode2D.Impulse);
                    Debug.Log("Complete.");
                }
                else if (animator.GetBool("isSideGrounding"))
                {
                    ...
                    // Perform the action for Up Air.
                    Vector2 knockbackForce = enemyKnockbackHandler.CalculateKnockback("SideGround", transform.position, enemy.transform.position, enemySprite.GetInteger("damage"), 0.6f);
                    // Apply the knockback force
                    enemyRb.AddForce(knockbackForce, ForceMode2D.Impulse);
                    Debug.Log("Complete.");
                    // Similarly, differentiate between Weak and Strong Up Air as needed.
